...
import 'package:NCSC/student/main_student.dart'; // Ensure student dashboard is imported
...
class email_verification extends StatefulWidget {
  ...
  @override
  State<email_verification> createState() =>
      _email_verificationState(user_name, pass, role);
}
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 30),
                    Text(
                      "Verification Email is sent to your Email ID ${widget.email_id}",
                    ),
                    SizedBox(height: 30),
                  ],
                ),
