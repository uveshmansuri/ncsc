                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoCard(
                        title: 'History',
                        content: 'Established in 1965 and recognized by the University Grants Commission in 1968, '
                      ...
                      _buildInfoCard(
                        title: 'Campus',
                        content: 'Located in Surat, Gujarat, the university spans over 210 acres, '
                      ...
                      _buildInfoCard(
                          ...
                          content:'VNSGU offers a wide range of undergraduate and postgraduate programs across various faculties such as Arts, Science, Commerce, Management, and Engineering. '
                              'The university has been re-accredited with a ‘B++’ grade by the National Accreditation and Assessment Council in 2022.',
                      ),

                      _buildInfoCard(
                          title: 'Notable Achievements',
                          content: 'The university has published over 2,000 scientific papers, contributing significantly to fields '
                      ...
                      _buildInfoCard(
                          ...
                          content: 'VNSGU has a vast network of affiliated institutions, including 34 Government, '
              ...
              ElevatedButton(
                  onPressed: (){
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context)=> WebView_Page(title: "Student Portal",url: "https://vnsgu.net")
                        )
                    );
                  },
                  child: Text("University Student Portal")
              ),
            ],
          ),
        ),
